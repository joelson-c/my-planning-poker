import type { FormAction } from "../components/pageActions/RoomJoinActions";
...
import RoomJoinActions from "../components/pageActions/RoomJoinActions";
...
export default function RoomJoin() {
    ...
    return (
        <div className="flex flex-col h-full justify-center items-center">
            <form
                className="flex flex-col gap-5 w-full xl:w-2/3"
                onSubmit={handleSubmit(onFormSubmit)}
                ref={formRef}
            >
                <Card
                    classNames={{ base: "bg-yellow-600", body: "text-black" }}
                >
                    <CardBody>
                        <p>
                            O primeiro usuário a entrar na sala se tornará um{" "}
                            <strong>moderador</strong>.
                        </p>
                        <p>
                            Apenas <strong>moderadores</strong> podem encerrar a
                            votação ou resetar a sala.
                        </p>
                    </CardBody>
                </Card>
                <Input
